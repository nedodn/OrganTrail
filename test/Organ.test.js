...
contract('Organ', (accounts) => {
    ...
    describe('Organ Submissions', () => {
        ...
        it('should only let signers sign a pending submission', async () => {
            ...
            tx = await organ.signSubmission(0, { from: accounts[1]}).should.be.fulfilled
    ...
    describe('Organ Transfers', () => {
        ...
        beforeEach(async () => {
            ...
            await organ.mintOrgan(0, accounts[4], 3, { from: accounts[4] } )
        })
        ...
        it('should only allow 2 party transfers to the approved', async () => {
            ...
            await organ.approve(accounts[4], 0, { from: accounts[7] }).should.be.fulfilled
            tx = await organ._transferFrom(accounts[7], accounts[4], 0, 32, { from: accounts[4] }).should.be.fulfilled
        ...
        it('can transfer to self?', async () => {
            await organ.approve(accounts[4], 0, { from: accounts[4] }).should.be.fulfilled
            await organ._transferFrom(accounts[4], accounts[4], 0, 32, { from: accounts[4] }).should.be.fulfilled
        })
